...
$ \frac{1}{2} x\_{1,\frac{T}{2}}(t) = \frac{1}{T}\int x(t) \phi(t)dt   - \frac{1}{2T}\int x(t) \phi(2t-\frac{T}{2})dt $

$ \frac{1}{2} x\_{1,\frac{T}{2}}(t) = \frac{1}{T}\int x(t) [\phi(t) -  \phi(2t-\frac{T}{2})]dt $

$  x\_{1,\frac{T}{2}}(t) = \frac{1}{T}\int x(t) [\phi(t) -  \phi(2t-\frac{T}{2})]dt $

Let us look at the function $\phi(t) -  \frac{1}{2}\phi(2t-\frac{T}{2})$
