...
h\_{l}[n]= $\frac{1}{\sqrt2} [ 1 , 1 ] $ or $h\_{l}[z] = \frac{1}{\sqrt2}[ 1 + z^{-1}]$
h\_{u}[n]= $\frac{1}{\sqrt2} [- 1 , 1 ] $ or $h\_{u}[z] = \frac{1}{\sqrt2}[ 1- z^{-1}]$
...
$y\_{l}[n] = \frac{1}{\sqrt2}  x[2n] + x[2n+1]$
$y\_{h}[n] = \frac{1}{\sqrt2}  x[2n] - x[2n+1]$

we can see that
$x\_{1}[n]=x[2n] = \frac{1}{\sqrt2} [y\_{l}[n] + y\_{h}[n] ]$
$x\_{1}[n]=x[2n+1] = \frac{1}{\sqrt2} [y\_{l}[n] - y\_{h}[n] ]$
...
$x\_{1}[n] = \frac{1}{\sqrt2} [y\_{l}[\frac{n}{2}] + y\_{h}[\frac{n}{2}] ]$
$x\_{2}[n] = \frac{1}{\sqrt2} [y\_{l}[\frac{n}{2}] - y\_{h}[\frac{n}{2}] ]$
$x[n] = x\_{1}[n] + x\_{2}[n-1]$
The delay element can be shifted to the source
$x[n] = \frac{1}{\sqrt2} [y\_{l}[\frac{n}{2}] + y\_{h}[\frac{n}{2}] ]+ [y\_{l}[\frac{n-1}{2}] - y\_{h}[\frac{n-1}{2}] ]$
$x[n] = \frac{1}{\sqrt2} [y\_{l}[\frac{n}{2}] + y\_{l}[\frac{n-1}{2}] ]+ [y\_{h}[\frac{n}{2}] - y\_{h}[\frac{n-1}{2}] ]$
$x[n] =  y\_{l}[\frac{n}{2}] * h\_{r,l}[n]+y\_{h}[\frac{n}{2}] *h\_{r,h}[n]$

where 
$h\_{r,l}[n]= \frac{1}{\sqrt2} [ \delta[n] + \delta[n-1] ]$ is called low pass reconstruction/synthesis filter
$h\_{r,h}[n]= \frac{1}{\sqrt2} [ \delta[n] - \delta[n-1] ]$ is called high pass reconstruction/synthesis filter

$h\_{r,l}[n]= \frac{1}{\sqrt2} [ 1, 1] $
$h\_{r,l}[n]= \frac{1}{\sqrt2} [ 1, -1] $
...
h\_{d,l}[n]= $\frac{1}{\sqrt2} [ 1 , 1 ] $ or $h\_{l}[z] = \frac{1}{\sqrt2}[ 1 + z^{-1}]$
h\_{d,u}[n]= $\frac{1}{\sqrt2} [- 1 , 1 ] $ or $h\_{u}[z] = \frac{1}{\sqrt2}[ 1- z^{-1}]$
...
$H\_{0}(w) = \frac{1}{\sqrt2} [ 1 + e^{-j\omega} ] $
$H\_{0}(w) = \sqrt{2}e^{-j\frac{\omega}{2}} cos(\frac{\omega}{2}) $
...
Let us look at the frequency response of these filter
$H\_{1}(w) = \frac{1}{\sqrt2} [ 1 - e^{-j\omega} ] $
$H\_{1}(w) = \sqrt{2}e^{-j\frac{\omega}{2}+\frac{j\pi}{2}} sin(\frac{\omega}{2}) $
...
h\_{r,l}[n]= $\frac{1}{\sqrt2} [ 1 , 1 ] $ or $h\_{l}[z] = \frac{1}{\sqrt2}[ 1 + z^{-1}]$
h\_{r,u}[n]= $\frac{1}{\sqrt2} [- 1 , 1 ] $ or $h\_{u}[z] = \frac{1}{\sqrt2}[ 1- z^{-1}]$
...
$\phi(t) = \sum\_{n} h[n] \phi(2t -n)$
$\psi(t) = \sum\_{n} g[n] \phi(2t -n)$
